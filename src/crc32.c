...
uint32_t CRC32_UpdateCRC_Buf(const void* buffer, size_t size, uint32_t crc) EMBETILE(CRC32_UpdateCRC_Buf);
uint32_t CRC32_AppendToCRC(const void* buffer, size_t size, uint32_t crc) EMBETILE(CRC32_AppendToCRC);
uint32_t CRC32_FinalizeCRC(uint32_t crc) EMBETILE(CRC32_FinalizeCRC);
#endif


static uint32_t crc32_tab[256] = {0x00000000U, 0x77073096U, 0xee0e612cU, 0x990951baU, 0x076dc419U, 0x706af48fU, 0xe963a535U, 0x9e6495a3U, 0x0edb8832U, 0x79dcb8a4U, 0xe0d5e91eU, 0x97d2d988U,
