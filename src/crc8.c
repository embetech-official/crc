...
uint8_t CRC8_InitCRC(void) EMBETILE(CRC8_InitCRC);
uint8_t CRC8_UpdateCRC_Byte(uint8_t byte, uint8_t crc) EMBETILE(CRC8_UpdateCRC_Byte);
uint8_t CRC8_UpdateCRC_Buf(const void* buf, size_t size, uint8_t crc) EMBETILE(CRC8_UpdateCRC_Buf);
#endif
